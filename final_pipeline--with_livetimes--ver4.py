...
path_save		=	os.getcwd() + '/plots/final_pipeline/my_method/GRB160802A/ver4/'
...
for i in range( Q_n ):
	...
	for j, timestamp in enumerate( x ):
		...
		if decision_flag	==	1:
			...
			ind_lvt	=	mf.nearest( livetime_mids, timestamp )
